...
![20171208_1]({{ site.url }}/images/20171208_1.png)
...
![20171208_2]({{ site.url }}/images/20171208_2.png)

浅蓝色代表对应的格子有学习得到的估值，灰色代表这部分不采样，也没有对应的估值（类似于监督学习这部分没有对应的标记，所以无法学习到东西）

这样实验过后得到的结果用下图展示：

![20171208_3]({{ site.url }}/images/20171208_3.png)
...
![20171208_4]({{ site.url }}/images/20171208_4.png)

这次着重观察了DQN和Double DQN（下面简称DDQN）在六个游戏中的表现，并且得到了这样的实验结果：

![20171208_5]({{ site.url }}/images/20171208_5.png)
